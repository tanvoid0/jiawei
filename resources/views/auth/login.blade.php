...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('loginr/css/style.css') }}">
...
<form action="{{ route('login') }}" method="post">
    ...
    <div class="inputGroup inputGroup1">
        ...
        <input type="email" id="loginEmail" name="email" maxlength="254" value="{{ old('email') }}"/>
...
<script  src="{{ asset('loginr/js/index.js') }}"></script>
